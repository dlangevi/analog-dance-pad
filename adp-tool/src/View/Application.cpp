...
// Unlike g_MainWindowData.FrameIndex, this is not the the swapchain image mappingIndex
...
static void FrameRender(ImGui_ImplVulkanH_Window* wd, ImDrawData* draw_data)
{
	...
	}
	{
		...
		// These use g_MainWindowData.FrameIndex and not s_CurrentFrameIndex because they're tied to the swapchain image mappingIndex
